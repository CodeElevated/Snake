...
public class GamePanel extends JPanel implements ActionListener, KeyListener{
    ...
    public void draw(Graphics g){
       ...
       // }
        ...
        g.fillRoundRect(snakeHead.x*tileSize, snakeHead.y*tileSize, tileSize, tileSize,7, 7);
        ...
        if(gameOver){
            ...
            g.drawString("Score: " + snakeBody.size(), (boardWidth - metrics.stringWidth("Score: "))/2, boardHeight/3);
